...
class Delaunay2d:
  ...
  # def generateShapefile(self, dirname, filename):
  ...
  #     i1, i2 = e
  #     # shapefile generator element
  #     writer.line(parts=[[[self.points[i1][0], self.points[i1][1]],[self.points[i2][0], self.points[i2][1]]]])
  #     writer.line(parts=[[[self.points[i2][0], self.points[i2][1]],[self.points[i1][0], self.points[i1][1]]]])
  ...
  def getGraph(self):
    ...
    for idx,item in enumerate(self.edge2Triangles):
      i1, i2 = item 
      pos1 = (self.points[i1][0], self.points[i1][1])
      pos2 = (self.points[i2][0], self.points[i2][1])
