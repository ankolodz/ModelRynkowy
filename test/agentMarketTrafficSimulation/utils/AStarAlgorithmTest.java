...
class AStarAlgorithmTest {
	...
	void setUp() throws Exception {
		...
		this.algorithm = new AStarAlgorithm(graph);
	...
	void test() {
		...
		assertEquals(distTime, 139181.5142, 0.0001);
		assertEquals(distCost, 139181.5142, 0.0001);
		assertEquals(distDist, 139181.5142, 0.0001);
	}
